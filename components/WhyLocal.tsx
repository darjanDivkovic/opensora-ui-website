...
const benefits = [
  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path
          d="M10 2l2.5 5H18l-4.5 3.5 1.5 5.5L10 13l-5 3 1.5-5.5L2 7h5.5z"
          stroke="currentColor"
          strokeWidth="1.4"
          strokeLinejoin="round"
        />
...
const comparison = [
  {
    label: "Monthly cost",
    cloud: "$30–150/mo",
    local: "$0 after one-time $49",
  },
  {
    label: "Generations",
    cloud: "Limited by credits",
    local: "Unlimited (pay GPU time only)",
  },
  {
    label: "Privacy",
    cloud: "Uploaded to servers",
    local: "Never sent to us. Zero telemetry.",
  },
  {
    label: "Queue wait",
    cloud: "30s–10min (platform queue)",
    local: "Your GPU, your queue",
  },
  {
    label: "Offline use",
    cloud: "Internet required",
    local: "Internet required (GPU is remote)",
  },
  { label: "Customization", cloud: "Platform presets", local: "Full control" },
  {
    label: "GPU cost",
    cloud: "Marked up in credits",
    local: "Native provider pricing",
  },
  {
    label: "Model cost",
    cloud: "Bundled into subscription",
    local: "Free (open-source)",
  },
  {
    label: "Model coverage",
    cloud: "One platform's models",
    local: "Any open-source model on the workstation",
  },
];
