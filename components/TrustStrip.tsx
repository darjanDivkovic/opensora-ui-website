...
export function TrustStrip() {
  ...
  return (
    <div className="relative border-y border-white/[0.06] bg-[#050505] overflow-hidden mt-[-25px] z-10">
      <div className="relative py-5">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 hidden md:block">
          <div className="px-4 py-1.5 rounded-full bg-[#050505] border border-white/[0.08]">
      ...
      {/* Secondary line */}
      <div className="border-t border-white/[0.04] py-3 px-6 text-center">
        <span className="font-mono text-[11px] text-text-dim tracking-wide">
          More model categories — image, audio, fine-tuning — coming to the same
          app.
        </span>
      </div>
    </div>
